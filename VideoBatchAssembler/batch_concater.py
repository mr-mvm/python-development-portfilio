...
# ===== SETTINGS =====
sequence_dir = Path("./sequences")     # folder containing concat .txt files
output_video_dir = Path("./outputs")   # folder to save concatenated videos
...
for txt_file in txt_files:
    # Get extension from first listed file
    ...
    if not first_clip_path.exists():
        print(f"⚠️ Skipping {txt_file.name} — {first_clip_name} not found in script directory")
        continue
